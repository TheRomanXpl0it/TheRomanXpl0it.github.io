...
1. if the binary representation of $m$ (the flag for example) ends with $0$ we can craft a message that will decrypts to $m2^{-1}$ and get the bit following the last zero (like a shift to the right)
