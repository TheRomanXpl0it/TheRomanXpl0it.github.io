...
<img class="img-responsive" src="{{ site-url }}/assets/codefest17/kappa.png" alt="Audio waveform in Audacity of audio file with clock sounds">

Apparently nothing.

But zooming in you can notice some irregualrities in the sound waves.

<img class="img-responsive" src="{{ site-url }}/assets/codefest17/kappa2.png" alt="Zoomed in view of audio waveform showing irregularities">
