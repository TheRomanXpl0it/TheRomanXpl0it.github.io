...
<img class="img-responsive" src="{{ site-url }}/assets/backdoorctf17/nocalm-1.png" alt="Screenshot of decompiled main() function checking flag length and conditions">
...
<img class="img-responsive" src="{{ site-url }}/assets/backdoorctf17/nocalm-2.png" alt="Screenshot of decompiled code checking for success() or fail() functions">
